...
#！！！！！！  1.改
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False,EIoU=False,MDPIoU=False,Shape_IoU=False,eps=1e-7):
    """
    ...
    iou = inter / union
    #！！！！！！   2.改
    if CIoU or DIoU or GIoU or EIoU or MDPIoU or Shape_IoU:   
        #----------------------------------------------------------------------#
        #  外接矩形的 宽 和 高
        #----------------------------------------------------------------------#
        ...
        #！！！！！！  3.改
        if CIoU or DIoU or EIoU or MDPIoU or Shape_IoU :   # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1   
            #-----------------------------------------------------------------#
            #  c2       ：外接矩形的 对角线的 平方
            #  rho2     : 求出两个矩阵A,B 中点的 平方
            #-----------------------------------------------------------------#
            ...
            #！！！！！！  4.改
                ...
                roh_w2= ((b1_x2 - b1_x1)-(b1_y2 - b1_y1))**2
                roh_h2= ((b2_x2 - b2_x1)-(b2_y2 - b2_y1))**2
                cw2 = cw ** 2 + eps
                ch2 = ch ** 2 + eps
                return iou-(rho2 / c2 + roh_w2 / cw2 + roh_h2 / ch2)
                ...
                return iou - d12 / (cw2+ch2)- d22 / (cw2+ch2)
